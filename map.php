<html>
	<head>
		...
		<script type="text/javascript" src="data.php?union=1&types=<?=$_GET['types']?>&distance=<?=$_GET['distance']?>&latitude=<?=$_GET['latitude']?>&longitude=<?=$_GET['longitude']?>&union=0"></script>
