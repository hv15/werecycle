#!/usr/bin/python
'''
Entry point for RecycleFinder i18n tool.

@author: Rodrigo Damazio
'''

import recyclefinder.files
import recyclefinder.translate
import recyclefinder.validate
import sys
...
def Translate(languages):
  ...
  '''
  validator = recyclefinder.validate.Validator(languages)
  validator.Validate()
  ...
  for lang in languages:
    ...
    translator = recyclefinder.translate.Translator(lang)
...
if __name__ == '__main__':
  ...
  languages = recyclefinder.files.GetAllLanguageFiles()
  if argc == 3:
    langs = set(argv[2:])
