...
own licenses, which allow their usage for the RecycleFinder application. Any other
...
- google-api-client-1.5.0-beta.jar depends on protobuf-java-2.2.0.jar, however,
  RecycleFinderLib already includes protobuf-java.2.3.0-lite.jar. Thus using the
