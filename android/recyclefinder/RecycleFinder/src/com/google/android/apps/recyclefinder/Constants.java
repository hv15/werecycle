...
/**
 * Constants used by the RecycleFinder application.
 *
...
public abstract class Constants {
   ...
   */
  public static final String TAG = "RecycleFinder";

  /**
   * Name of the top-level directory inside the SD card where our files will
   * be read from/written to.
   */
  public static final String SDCARD_TOP_DIR = "RecycleFinder";
  ...
  public static final String
      RESUME_TRACK_EXTRA_NAME = "com.google.android.apps.recyclefinder.RESUME_TRACK";
