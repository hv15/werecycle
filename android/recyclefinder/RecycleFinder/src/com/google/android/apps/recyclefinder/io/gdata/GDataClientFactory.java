 ...
 * the License.
 */
package com.google.android.apps.recyclefinder.io.gdata;
...
public class GDataClientFactory {
  ...
  public static GDataClient getGDataClient(Context context) {
    ...
    try {
      ...
      // apk.
      Log.i(Constants.TAG, "Using recyclefinder AndroidGDataClient.", e);
      return new com.google.android.apps.recyclefinder.io.gdata.AndroidGDataClient();
    }
  }
}
