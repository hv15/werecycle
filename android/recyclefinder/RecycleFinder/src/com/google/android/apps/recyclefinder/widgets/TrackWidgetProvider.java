...
package com.google.android.apps.recyclefinder.widgets;

import com.google.android.apps.recyclefinder.TrackDetailActivity;
import com.google.android.apps.recyclefinder.TrackListActivity;
...
import com.google.android.apps.recyclefinder.services.ControlRecordingService;
...
/**
 * A track widget to start/stop/pause/resume recording, launch RecycleFinder, and
...
public class TrackWidgetProvider extends AppWidgetProvider {
  ...
  private void update(Context context, long trackId) {
    ...
    RecycleFinderProviderUtils recycleFinderProviderUtils = RecycleFinderProviderUtils.Factory.get(context);
    if (trackId == -1L) {
    ...
    Track track = trackId != -1L ? recycleFinderProviderUtils.getTrack(trackId)
        : recycleFinderProviderUtils.getLastTrack();
