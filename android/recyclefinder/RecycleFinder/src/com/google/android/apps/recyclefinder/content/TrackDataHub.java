...
import static com.google.android.apps.recyclefinder.Constants.MAX_DISPLAYED_WAYPOINTS_POINTS;
import static com.google.android.apps.recyclefinder.Constants.MAX_LOCATION_AGE_MS;
import static com.google.android.apps.recyclefinder.Constants.MAX_NETWORK_AGE_MS;
import static com.google.android.apps.recyclefinder.Constants.TARGET_DISPLAYED_TRACK_POINTS;

import com.google.android.apps.recyclefinder.Constants;
import com.google.android.apps.recyclefinder.content.RecycleFinderProviderUtils.DoubleBufferedLocationFactory;
import com.google.android.apps.recyclefinder.content.RecycleFinderProviderUtils.LocationIterator;
import com.google.android.apps.recyclefinder.content.TrackDataListener.LocationState;
...
public class TrackDataHub implements DataSourceListener {
  ...
  public synchronized static TrackDataHub newInstance(Context context) {
    return new TrackDataHub(context, new TrackDataManager(), RecycleFinderProviderUtils.Factory.get(
   ...
   * @param recycleFinderProviderUtils the recyclefinder provider utils
   * @param targetNumPoints the target number of points
   */
  @VisibleForTesting
  TrackDataHub(Context context, TrackDataManager trackDataManager,
      RecycleFinderProviderUtils recycleFinderProviderUtils, int targetNumPoints) {
  ...
  private void notifySelectedTrackChanged(Set<TrackDataListener> trackDataListeners) {
    ...
    Track track = recycleFinderProviderUtils.getTrack(selectedTrackId);
  ...
  private void notifyTrackPointsTableUpdate(boolean updateSamplingState,
    ...
    long lastTrackPointId = recycleFinderProviderUtils.getLastTrackPointId(selectedTrackId);
    int samplingFrequency = -1;
    LocationIterator iterator = recycleFinderProviderUtils.getTrackPointLocationIterator(
