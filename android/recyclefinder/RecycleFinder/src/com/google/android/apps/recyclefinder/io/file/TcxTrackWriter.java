...
import com.google.android.apps.recyclefinder.lib.R;
...
public class TcxTrackWriter implements TrackFormatWriter {
  ...
  // RecycleFinder categories that are considered as TCX biking sport type.
  ...
  // RecycleFinder categories that are considered as TCX running sport type.
  ...
  public void writeFooter() {
    if (printWriter != null) {
      ...
      printWriter.println("<Name>" 
          + StringUtils.formatCData(context.getString(R.string.send_google_by_recyclefinder, "", "")) 
          + "</Name>");
  ...
  private void writeVersion() {
    // Split the RecycleFinder version code into VersionMajor, VersionMinor, and,
    // BuildMajor to fit the integer type requirement for these fields in the
    // TCX spec.
    String[] versionComponents = SystemUtils.getRecycleFinderVersion(context).split("\\.");
