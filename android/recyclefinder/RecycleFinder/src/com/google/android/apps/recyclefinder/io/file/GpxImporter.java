 ...
 * the License.
 */
package com.google.android.apps.recyclefinder.io.file;
...
import com.google.android.apps.recyclefinder.services.TrackRecordingService;
...
/**
 * Imports GPX file to RecycleFinder.
 * 
...
public class GpxImporter extends DefaultHandler {
   ...
   * @param recycleFinderProviderUtils recyclefinder provider utils
  ...
  public static long[] importGPXFile(InputStream inputStream,
      RecycleFinderProviderUtils recycleFinderProviderUtils, int minRecordingDistance)
      throws ParserConfigurationException, SAXException, IOException {
    SAXParserFactory saxParserFactory = SAXParserFactory.newInstance();
    SAXParser saxParser = saxParserFactory.newSAXParser();
    GpxImporter gpxImporter = new GpxImporter(recycleFinderProviderUtils, minRecordingDistance);
  ...
  public GpxImporter(RecycleFinderProviderUtils recycleFinderProviderUtils, int minRecordingDistance) {
  ...
  public void rollbackUnfinishedTracks() {
    if (!isCurrentTrackFinished && track != null) {
      recycleFinderProviderUtils.deleteTrack(track.getId());
  ...
  private void flushPoints() {
    ...
    recycleFinderProviderUtils.bulkInsertTrackPoint(
  ...
  private long getFirstPointId() {
    flushPoints();
    return recycleFinderProviderUtils.getFirstTrackPointId(track.getId());
  }
  ...
  private long getLastPointId() {
    flushPoints();
    return recycleFinderProviderUtils.getLastTrackPointId(track.getId());
  }
