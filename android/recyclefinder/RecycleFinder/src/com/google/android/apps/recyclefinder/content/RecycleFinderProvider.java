 ...
 */
public class RecycleFinderProvider extends ContentProvider {

  private static final String TAG = RecycleFinderProvider.class.getSimpleName();
  @VisibleForTesting
  static final String DATABASE_NAME = "recyclefinder.db";
  ...
  public RecycleFinderProvider() {
    uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
    uriMatcher.addURI(RecycleFinderProviderUtils.AUTHORITY, TrackPointsColumns.TABLE_NAME,
        UrlType.TRACKPOINTS.ordinal());
    uriMatcher.addURI(RecycleFinderProviderUtils.AUTHORITY, TrackPointsColumns.TABLE_NAME + "/#",
        UrlType.TRACKPOINTS_ID.ordinal());
    uriMatcher.addURI(
        RecycleFinderProviderUtils.AUTHORITY, TracksColumns.TABLE_NAME, UrlType.TRACKS.ordinal());
    uriMatcher.addURI(RecycleFinderProviderUtils.AUTHORITY, TracksColumns.TABLE_NAME + "/#",
        UrlType.TRACKS_ID.ordinal());
    uriMatcher.addURI(
        RecycleFinderProviderUtils.AUTHORITY, WaypointsColumns.TABLE_NAME, UrlType.WAYPOINTS.ordinal());
    uriMatcher.addURI(RecycleFinderProviderUtils.AUTHORITY, WaypointsColumns.TABLE_NAME + "/#",
  ...
  public int delete(Uri url, String where, String[] selectionArgs) {
    ...
    Log.w(RecycleFinderProvider.TAG, "Deleting table " + table);
    int count;
    try {
      db.beginTransaction();
