...
package com.google.android.apps.recyclefinder.io.fusiontables;
...
import com.google.android.apps.recyclefinder.util.SystemUtils;
...
public class SendFusionTablesAsyncTask extends AbstractSendAsyncTask {
  ...
  @VisibleForTesting
  public static final String APP_NAME_PREFIX = "Google-RecycleFinder-";
  ...
  public SendFusionTablesAsyncTask(
    ...
    recycleFinderProviderUtils = RecycleFinderProviderUtils.Factory.get(context);
    ...
    try {
      ...
      if (cursor != null && cursor.moveToFirst()) {
        ...
        while (cursor.moveToNext()) {
          Waypoint wpt = recycleFinderProviderUtils.createWaypoint(cursor);
  ...
  private boolean sendQuery(String query, boolean setTableId) {
    ...
    headers.setApplicationName(APP_NAME_PREFIX + SystemUtils.getRecycleFinderVersion(context));
