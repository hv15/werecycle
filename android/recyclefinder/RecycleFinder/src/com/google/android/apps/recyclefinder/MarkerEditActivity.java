 ...
 * @author Jimmy Shih
 */
public class MarkerEditActivity extends AbstractRecycleFinderActivity {
  ...
  private void updateUiByMarkerId() {
    ...
    if (newMarker) {
      ...
      int nextWaypointNumber = trackId == -1L ? -1
          : RecycleFinderProviderUtils.Factory.get(this).getNextWaypointNumber(trackId, false);
      ...
      waypoint = RecycleFinderProviderUtils.Factory.get(this).getWaypoint(markerId);
      if (waypoint == null) {
  ...
  private void saveMarker() {
    ...
    RecycleFinderProviderUtils.Factory.get(this).updateWaypoint(waypoint);
  }
}
