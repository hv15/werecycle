...
import com.google.android.apps.recyclefinder.content.TrackDataHub;
...
import com.google.android.apps.recyclefinder.fragments.ChartFragment;
import com.google.android.apps.recyclefinder.fragments.ChooseActivityDialogFragment;
import com.google.android.apps.recyclefinder.fragments.ChooseUploadServiceDialogFragment;
import com.google.android.apps.recyclefinder.fragments.DeleteOneTrackDialogFragment;
import com.google.android.apps.recyclefinder.fragments.DeleteOneTrackDialogFragment.DeleteOneTrackCaller;
import com.google.android.apps.recyclefinder.fragments.FrequencyDialogFragment;
import com.google.android.apps.recyclefinder.fragments.InstallEarthDialogFragment;
import com.google.android.apps.recyclefinder.fragments.MapFragment;
import com.google.android.apps.recyclefinder.fragments.StatsFragment;
import com.google.android.apps.recyclefinder.io.file.SaveActivity;
import com.google.android.apps.recyclefinder.io.file.TrackWriterFactory.TrackFileFormat;
import com.google.android.apps.recyclefinder.io.sendtogoogle.SendRequest;
import com.google.android.apps.recyclefinder.services.TrackRecordingServiceConnection;
import com.google.android.apps.recyclefinder.settings.SettingsActivity;
...
import com.google.android.apps.recyclefinder.util.TrackRecordingServiceConnectionUtils;
 ...
 */
public class TrackDetailActivity extends AbstractRecycleFinderActivity implements DeleteOneTrackCaller {
  ...
  private void handleIntent(Intent intent) {
    ...
    if (markerId != -1L) {
      Waypoint waypoint = RecycleFinderProviderUtils.Factory.get(this).getWaypoint(markerId);
      if (waypoint == null) {
        exit();
        return;
      }
  ...
  private void updateMenuItems(boolean isRecording, boolean isPaused) {
    ...
    if (isRecording) {
      ...
      Track track = RecycleFinderProviderUtils.Factory.get(this).getTrack(trackId);
      title = track != null ? track.getName() : getString(R.string.recyclefinder_app_name);
    }
    setTitle(title);
  }
