 ...
 * the License.
 */
package com.google.android.apps.recyclefinder.io.maps;

import com.google.android.apps.recyclefinder.Constants;
import com.google.android.apps.recyclefinder.content.DescriptionGenerator;
...
import com.google.android.apps.recyclefinder.io.gdata.GDataClientFactory;
import com.google.android.apps.recyclefinder.io.gdata.maps.MapsClient;
import com.google.android.apps.recyclefinder.io.gdata.maps.MapsConstants;
import com.google.android.apps.recyclefinder.io.gdata.maps.MapsGDataConverter;
import com.google.android.apps.recyclefinder.io.gdata.maps.XmlMapsGDataParserFactory;
import com.google.android.apps.recyclefinder.io.sendtogoogle.AbstractSendAsyncTask;
import com.google.android.apps.recyclefinder.io.sendtogoogle.SendToGoogleUtils;
 ...
 * the Google Maps servers through this API is only allowed for the RecycleFinder
...
public class SendMapsAsyncTask extends AbstractSendAsyncTask {
  ...
  private final RecycleFinderProviderUtils recycleFinderProviderUtils;
  ...
  public SendMapsAsyncTask(
    ...
    this(activity, trackId, account, chooseMapId, RecycleFinderProviderUtils.Factory.get(
  ...
  public SendMapsAsyncTask(SendMapsActivity activity, long trackId, Account account,
      String chooseMapId, RecycleFinderProviderUtils recycleFinderProviderUtils) {
    super(activity);
    this.trackId = trackId;
    this.account = account;
    this.chooseMapId = chooseMapId;
    this.recycleFinderProviderUtils = recycleFinderProviderUtils;
    ...
    if (chooseMapId != null) {
      ...
      try {
        String description = track.getCategory() + "\n" + track.getDescription() + "\n"
            + context.getString(R.string.send_google_by_recyclefinder, "", "");
  ...
  boolean uploadAllTrackPoints(Track track) {
    Cursor cursor = null;
    try {
      cursor = recycleFinderProviderUtils.getTrackPointCursor(trackId, 0, -1, false);
      if (cursor == null) {
  ...
  boolean uploadWaypoints() {
    Cursor cursor = null;
    try {
      cursor = recycleFinderProviderUtils.getWaypointCursor(
      ...
      if (cursor != null && cursor.moveToFirst()) {
        ...
        while (cursor.moveToNext()) {
          ...
          Waypoint waypoint = recycleFinderProviderUtils.createWaypoint(cursor);
          try {
