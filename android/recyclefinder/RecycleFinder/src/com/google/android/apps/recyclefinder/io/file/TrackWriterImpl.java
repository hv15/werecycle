...
import static com.google.android.apps.recyclefinder.Constants.TAG;
...
import com.google.android.apps.recyclefinder.util.FileUtils;
...
class TrackWriterImpl implements TrackWriter {
  ...
  private final RecycleFinderProviderUtils providerUtils;
  ...
  TrackWriterImpl(Context context, RecycleFinderProviderUtils providerUtils,
  ...
  private void writeLocations() throws InterruptedException {
    ...
    class TrackWriterLocationFactory implements RecycleFinderProviderUtils.LocationFactory {
      ...
      public Location createLocation() {
        if (currentLocation == null) {
          currentLocation = new RecycleFinderLocation("");
        }
