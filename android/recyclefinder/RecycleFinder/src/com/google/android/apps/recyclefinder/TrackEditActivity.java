 ...
 */
public class TrackEditActivity extends AbstractRecycleFinderActivity {
  ...
  protected void onCreate(Bundle bundle) {
    ...
    track = recycleFinderProviderUtils.getTrack(trackId);
    if (track == null) {
    ...
    if (getIntent().getBooleanExtra(EXTRA_NEW_TRACK, false)) {
      String trackName = TrackNameUtils.getTrackName(
          this, -1L, -1L, recycleFinderProviderUtils.getLastValidTrackPoint(trackId));
      if (trackName != null) {
