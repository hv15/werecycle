...
import com.google.android.apps.recyclefinder.util.ChartURLGenerator;
...
/**
 * An implementation of {@link DescriptionGenerator} for RecycleFinder.
 *
 * @author Jimmy Shih
 */
public class DescriptionGeneratorImpl implements DescriptionGenerator {
  ...
  public String generateTrackDescription(
    ...
    String beginAnchor = html 
        ? "<a href='http://" + context.getString(R.string.recyclefinder_web_url) + "'>"
        : "";
    String endAnchor = html ? "</a>" : "";
    builder.append(context.getString(R.string.send_google_by_recyclefinder, beginAnchor, endAnchor));
