 ...
 * the License.
 */
package com.google.android.apps.recyclefinder.util;

import com.google.android.apps.recyclefinder.Constants;
import com.google.android.apps.recyclefinder.ContextualActionModeCallback;
import com.google.android.apps.recyclefinder.io.backup.BackupPreferencesListener;
import com.google.android.apps.recyclefinder.services.sensors.BluetoothConnectionManager;
import com.google.android.apps.recyclefinder.services.tasks.AnnouncementPeriodicTask;
import com.google.android.apps.recyclefinder.services.tasks.PeriodicTask;
...
public class Api7Adapter implements ApiAdapter {
  ...
  public BluetoothSocket getBluetoothSocket(BluetoothDevice bluetoothDevice) throws IOException {
    ...
    return bluetoothDevice.createRfcommSocketToServiceRecord(BluetoothConnectionManager.RECYCLEFINDER_UUID);
  }
