...
package com.google.android.apps.recyclefinder.services.sensors.ant;
...
import com.google.android.apps.recyclefinder.content.Sensor.SensorState;
...
public class AntSensorManager extends SensorManager {
  ...
  private void tryClaimAnt() {
    try {
      antInterface.requestForceClaimInterface(context.getString(R.string.recyclefinder_app_name));
    } catch (AntInterfaceException e) {
      handleAntError();
    }
  }
