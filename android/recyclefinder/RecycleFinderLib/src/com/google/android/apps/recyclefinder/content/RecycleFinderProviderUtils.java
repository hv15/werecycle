...
/**
 * Utilities to access data from the RecycleFinder content provider.
 * 
 * @author Rodrigo Damazio
 */
public interface RecycleFinderProviderUtils {

  /**
   * The authority (the first part of the URI) for the RecycleFinder content
   * provider.
   */
  public static final String AUTHORITY = "com.google.android.maps.recyclefinder";
  ...
  public class DoubleBufferedLocationFactory implements LocationFactory {
    ...
    private final Location locations[] = new RecycleFinderLocation[] {
        new RecycleFinderLocation(LocationManager.GPS_PROVIDER),
        new RecycleFinderLocation(LocationManager.GPS_PROVIDER) };
  ...
  /**
   * A factory which can produce instances of {@link RecycleFinderProviderUtils}, and
  ...
  public static class Factory {
    ...
    /**
     * Creates an instance of {@link RecycleFinderProviderUtils}.
     * 
     * @param context the context
     */
    public static RecycleFinderProviderUtils get(Context context) {
    ...
    /**
     * Creates an instance of {@link RecycleFinderProviderUtils}. Allows subclasses
     * to override for testing.
     * 
     * @param context the context
     */
    protected RecycleFinderProviderUtils newForContext(Context context) {
      return new RecycleFinderProviderUtilsImpl(context.getContentResolver());
    }
  }
}
