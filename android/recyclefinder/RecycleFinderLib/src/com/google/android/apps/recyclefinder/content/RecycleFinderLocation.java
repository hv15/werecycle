 ...
 */
public class RecycleFinderLocation extends Location {
  ...
  public RecycleFinderLocation(Location location, Sensor.SensorDataSet sd) {
    super(location);
    this.sensorDataSet = sd;
  }

  public RecycleFinderLocation(String provider) {
    super(provider);
  }
