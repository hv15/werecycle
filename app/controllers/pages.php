...
class Pages extends CI_Controller {
	...
	public function check()
	{
		...
		$outletsarray3 = $this->map_model->get_outlets($types,$latitude,$longitude,3);
		if(count($outletsarray3 > 0)) {
			$data['code'] = 2;
			$data['message'] = "There is at least one recycle point within 3 miles of this location which allows all of the types you have selected";
		} else {		
