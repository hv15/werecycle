		...
		$.get('/datanew/'+urlRand, function(dataResponse) {
			...
			for (var i = 0; i < clusterData.clusters.length; i++) {
				...
				if(cluster.count > 100) {
					...
					var clusterLabelAnchor = new google.maps.Point(28,28);
